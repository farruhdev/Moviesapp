...
public class MainActivity extends AppCompatActivity {
   ...
   private Handler slideHandler = new Handler();
    ...
    private void banners() {
        List<Sliderltems> backslider=new ArrayList<>();
        backslider.add(new Sliderltems(R.drawable.wide));
        backslider.add(new Sliderltems (R.drawable.wide1));
        backslider.add(new Sliderltems(R.drawable.wide3));

        viewPager2.setAdapter(new SliderAdapters(backslider,viewPager2));
